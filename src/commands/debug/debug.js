...
async function listAttributeGroups(options) {
...
async function getAttributeGroup() {
    const realmAnswers = await inquirer.prompt(realmPrompt());
    const realm = realmAnswers.realm;
    const instanceType = getInstanceType(realm);
    const objectTypeAnswers = await inquirer.prompt(objectTypePrompt('SitePreferences'));
...
async function testActivePreferences() {
...
async function findPreferenceUsageCommand() {
...
async function testPatchAttribute() {
    const realmAnswers = await inquirer.prompt(realmPrompt());
...
async function testPutAttribute() {
    const realmAnswers = await inquirer.prompt(realmPrompt());
    const objectTypeAnswers = await inquirer.prompt(objectTypePrompt());
    const attributeAnswers = await inquirer.prompt([
        {
...
async function testSetSitePreference() {
    const realmAnswers = await inquirer.prompt(realmPrompt());
...
async function testBackupRestoreCycle() {
    const timer = startTimer();
    console.log('\n========================================');
...
async function findAttributeGroupInMeta() {
    const siblings = await getSiblingRepositories();
...
async function testGenerateBackupJson() {
    const timer = startTimer();
...
async function testConcurrentTimers() {
...
async function checkApiEndpoints(options) {
